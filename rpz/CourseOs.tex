...
\usepackage[cp1251]{inputenc} % настройка кодировки
...
\graphicspath{{images/}} % Относительный путь к каталогу с рисунками
...
\begin{document}
\def\figurename{Рисунок} % префикс к рисунками
\input{CourseOS-Title}
\tableofcontents
\input{CourseOS-Intro}
\input{CourseOS-Anal}
\input{CourseOS-Constructor}
\input{CourseOS-Techic}
\input{CourseOS-Conclusion}
\input{CourseOS-Biblio}
\input{CourseOS-Appendix}
\end{document}